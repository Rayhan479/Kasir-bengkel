...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Toko Sparepart<sup></sup></div>
    </a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                <a class="collapse-item" href="index.php?page=pengguna">Tambah User</a>
                <a class="collapse-item" href="index.php?page=pengguna/data">Daftar User</a>
                <!-- <a class="collapse-item" href="index.php?page=user">User</a> -->
            </div>
        </div>
    </li>
